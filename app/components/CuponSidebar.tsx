...
import { Trash2, ChevronDown, TicketCheck } from 'lucide-react'
...
export default function CuponSidebar() {
  ...
  return (
    <>
      <div className="w-80 shrink-0 self-start overflow-hidden rounded-[var(--radius-lg)] border border-border-medium bg-surface shadow-lg shadow-black/5">
        <button
